  ...
  return (
    <header className="site-header">
      ...
      <div className="header-actions">
        <nav className="liquid-glass" aria-label="主导航">{navigation.map(([label, href]) => <Link href={href} key={href}>{label}</Link>)}</nav>
        <div className="social-actions liquid-glass" aria-label="社交媒体">
