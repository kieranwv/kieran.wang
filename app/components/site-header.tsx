...
const navigation = [["projects", "/projects"], ["posts", "/posts"], ["photos", "/photos"]] as const;
    ...
    <header className="site-header">
      ...
      <div className="header-actions">
        ...
        <div className="social-actions" aria-label="社交媒体">
          ...
          <a className="icon-button" href="https://juejin.cn/user/1141722285880972" rel="noreferrer" target="_blank" aria-label="掘金">
            <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2.15 1.75 8.22 12 14.3l10.25-6.08L12 2.15ZM2.9 12.05l-1.15.68 10.25 6.08 10.25-6.08-1.15-.68L12 17.45 2.9 12.05Zm0 4.12-1.15.68L12 22.93l10.25-6.08-1.15-.68L12 21.53 2.9 16.17Z" /></svg>
          </a>
        </div>
      </div>
    </header>
